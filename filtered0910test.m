...
[Y, t_Y, Dclutter] = realACfetch0910(realTarg,stops,35); % !!!This script has the
...
ms   =[800,800]%[150,150,150,150,15]; % number of atoms to train for each class
...
hndl=figure;
hold on
plot(P_faSVD,P_dSVD);%plot(P_faSVD,P_dSVD,P_faKSVD,P_dKSVD,P_faLP,P_dLP );%
